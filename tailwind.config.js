  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "display-hero": ["'Festive'", "'UnifrakturCook'", "'Bodoni Moda'", "cursive"],
        "body-md": ["'Geist'", "sans-serif"],
        "headline-md": ["'Bodoni Moda'", "serif"],
        "headline-lg": ["'Bodoni Moda'", "serif"],
        "body-sm": ["'Geist'", "sans-serif"],
        "display-hero-mobile": ["'Festive'", "'UnifrakturCook'", "'Bodoni Moda'", "cursive"],
        "headline-xl-mobile": ["'Festive'", "'UnifrakturCook'", "'Bodoni Moda'", "cursive"],
        "headline-xl": ["'Festive'", "'UnifrakturCook'", "'Bodoni Moda'", "cursive"],
