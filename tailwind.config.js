  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "display-hero": ["'UnifrakturCook'", "'UnifrakturMaguntia'", "'Pirata One'", "serif"],
        "body-md": ["'Geist'", "sans-serif"],
        "headline-md": ["'Bodoni Moda'", "serif"],
        "headline-lg": ["'Bodoni Moda'", "serif"],
        "body-sm": ["'Geist'", "sans-serif"],
        "display-hero-mobile": ["'UnifrakturCook'", "'UnifrakturMaguntia'", "'Pirata One'", "serif"],
        "headline-xl-mobile": ["'UnifrakturCook'", "'UnifrakturMaguntia'", "'Pirata One'", "serif"],
        "headline-xl": ["'UnifrakturCook'", "'UnifrakturMaguntia'", "'Pirata One'", "serif"],
        "gothic": ["'UnifrakturCook'", "'UnifrakturMaguntia'", "'Pirata One'", "serif"],
        "blackletter": ["'UnifrakturCook'", "'UnifrakturMaguntia'", "'Pirata One'", "serif"],
