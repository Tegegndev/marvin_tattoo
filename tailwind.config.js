  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "display-hero": ["'Limelight'", "'Bodoni Moda'", "serif"],
        "body-md": ["'Geist'", "sans-serif"],
        "headline-md": ["'Bodoni Moda'", "serif"],
        "headline-lg": ["'Bodoni Moda'", "serif"],
        "body-sm": ["'Geist'", "sans-serif"],
        "display-hero-mobile": ["'Limelight'", "'Bodoni Moda'", "serif"],
        "headline-xl-mobile": ["'Limelight'", "'Bodoni Moda'", "serif"],
        "headline-xl": ["'Limelight'", "'Bodoni Moda'", "serif"],
