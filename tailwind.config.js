  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "display-hero": ["'Pirata One'", "'UnifrakturMaguntia'", "'Bodoni Moda'", "serif"],
        "body-md": ["'Geist'", "sans-serif"],
        "headline-md": ["'Bodoni Moda'", "serif"],
        "headline-lg": ["'Bodoni Moda'", "serif"],
        "body-sm": ["'Geist'", "sans-serif"],
        "display-hero-mobile": ["'Pirata One'", "'UnifrakturMaguntia'", "'Bodoni Moda'", "serif"],
        "headline-xl-mobile": ["'Pirata One'", "'UnifrakturMaguntia'", "'Bodoni Moda'", "serif"],
        "headline-xl": ["'Pirata One'", "'UnifrakturMaguntia'", "'Bodoni Moda'", "serif"],
        "gothic": ["'Pirata One'", "'UnifrakturMaguntia'", "serif"],
        "blackletter": ["'UnifrakturMaguntia'", "'Pirata One'", "serif"],
