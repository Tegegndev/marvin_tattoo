...
export const BookingPage: React.FC<BookingPageProps> = ({
  ...
  return (
    <div className="w-full pt-20 bg-noir-950 min-h-screen">
      <div className="relative w-full overflow-hidden bg-noir-950 text-bone">
        {/* Glow Spheres */}
        <div className="absolute inset-0 pointer-events-none opacity-20">
          <div className="absolute -top-32 left-1/4 w-96 h-96 rounded-full bg-crimson blur-[140px]" />
          <div className="absolute top-1/2 -right-20 w-80 h-80 rounded-full bg-gold/20 blur-[130px]" />
        </div>

        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 py-8 lg:py-12">
          {/* Header Banner */}
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-noir-700">
            <div className="space-y-3 max-w-3xl">
              ...
              <h1 className="font-headline-xl text-3xl sm:text-4xl md:text-6xl text-bone tracking-tight leading-none font-bold">
                Tattoo &amp; Pierce
              </h1>
            ...
            <button
              ...
              className="inline-flex items-center justify-between gap-4 px-5 py-3.5 bg-noir-800 hover:bg-noir-700 text-bone transition-all shadow-md group border border-noir-700"
            >
              <div className="flex items-center gap-3">
              ...
              <ArrowRight className="w-4 h-4 text-bone-dim group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
          ...
          {!isSubmitted ? (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 pt-10">
              ...
              <form onSubmit={handleSubmit} className="lg:col-span-8 space-y-12">
                ...
                <section className="space-y-6">
                  <div className="flex items-baseline justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <h2 className="font-headline-sm text-lg sm:text-xl text-bone tracking-wide uppercase font-bold">
                        Choose a Service
                      </h2>
                    </div>
                    <span className="font-label-data text-xs text-bone-dim font-semibold">
                      {selectedDiscipline}
                    </span>
                  </div>
                    ...
                    {disciplines.map((d) => {
                      ...
                      return (
                        <div
                          ...
                          className={`cursor-pointer group relative flex flex-col justify-between p-5 bg-noir-850 transition-all overflow-hidden border ${
                            isSelected
                              ? 'border-crimson ring-1 ring-crimson bg-noir-800'
                        ...
                        >
                          ...
                          />
                          <div className="absolute inset-0 bg-gradient-to-t from-noir-850/95 via-noir-850/80 to-noir-850/40 pointer-events-none" />
                          ...
                          <div className="relative z-10 flex justify-between items-start mb-6">
                            ...
                            <div
                              className={`w-4 h-4 rounded-full flex items-center justify-center border ${
                                isSelected ? 'bg-crimson border-crimson' : 'border-noir-700 bg-noir-700'
                              }`}
                            >
                          ...
                          <div className="relative z-10">
                            <h3 className="font-title-editorial text-base text-bone group-hover:text-crimson-light transition-colors font-bold">
                              {d.id}
                            </h3>
                            <p className="font-body-sm text-xs text-bone-muted mt-1 leading-snug">
                              {d.desc}
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="p-6 bg-noir-850 border border-noir-700 space-y-6">
                    ...
                    <div className="pt-4 border-t border-noir-700">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="font-label-data text-xs text-gold">
                          {selectedZone}
                        </span>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 p-4 bg-noir-900 border border-noir-700 items-center">
                        <div className="md:col-span-4 relative overflow-hidden bg-noir-950 h-40">
                          <img
                          ...
                          />
                          <div className="absolute bottom-2 left-2 px-2 py-0.5 bg-noir-950/90 text-crimson-light font-label-caps text-[9px] uppercase border border-crimson/30">
                            Scope: {selectedDimension}
                          </div>
                        </div>
                        <div className="md:col-span-8 space-y-3">
                          <div className="grid grid-cols-3 gap-2">
                            <div className="p-2 bg-noir-850 border border-noir-700 text-center">
                              <span className="block font-label-caps text-bone-dim uppercase text-[9px]">Zone</span>
                              <span className="font-title-editorial text-bone text-xs truncate block">{selectedZone}</span>
                            </div>
                            <div className="p-2 bg-noir-850 border border-noir-700 text-center">
                              <span className="block font-label-caps text-bone-dim uppercase text-[9px]">Protocol</span>
                              <span className="font-title-editorial text-crimson-light text-xs truncate block">1-2 Sessions</span>
                            </div>
                            <div className="p-2 bg-noir-850 border border-noir-700 text-center">
                              <span className="block font-label-caps text-bone-dim uppercase text-[9px]">Sterilization</span>
                              <span className="font-title-editorial text-gold text-xs truncate block">Autoclave</span>
                            </div>
                          </div>
                          <p className="font-body-sm text-xs text-bone-dim leading-snug">
                ...
                <section className="space-y-6">
                  ...
                  <div className="p-6 bg-noir-850 border border-noir-700 space-y-6">
                    ...
                    <div className="space-y-2">
                      <label className="font-label-caps text-xs text-bone-dim block uppercase tracking-wider">
                        About Your Tattoo
                      </label>
                      <textarea
                        rows={4}
                        ...
                        className="w-full p-4 bg-noir-900 border border-noir-700 text-bone placeholder:text-bone-dim font-body-md text-sm focus:outline-none focus:border-crimson transition-colors resize-none"
                      />
                    </div>
                        ...
                        {[
                          ...
                          return (
                            <div
                              ...
                              className={`p-3 bg-noir-900 border cursor-pointer transition-all ${
                                isVaultActive
                                  ? 'border-crimson ring-1 ring-crimson bg-noir-700'
                                  : 'border-noir-700 hover:border-noir-600'
                              }`}
                            >
                              <div className="relative h-28 overflow-hidden bg-noir-950 mb-2">
                                <img
                                  src={vault.img}
                                  alt={vault.title}
                              ...
                              <h4 className="font-title-editorial text-sm text-bone truncate">
                                {vault.title}
                              </h4>
                              <p className="font-body-sm text-[11px] text-bone-dim truncate mt-0.5">
                                {vault.sub}
                              </p>
                            </div>
                          );
                    ...
                    <div className="p-6 bg-noir-900 border-dashed border border-noir-700 hover:border-noir-600 text-center transition-colors cursor-pointer group">
                      <Upload className="w-8 h-8 text-bone-dim group-hover:text-crimson-light transition-colors mx-auto mb-2" />
                ...
                <section className="space-y-6">
                    ...
                    {ARTISTS_DATA.map((art) => {
                      ...
                      return (
                        <div
                          ...
                          className={`cursor-pointer p-4 bg-noir-850 transition-all flex flex-col justify-between border ${
                            isArtSelected
                              ? 'border-crimson ring-1 ring-crimson bg-noir-700'
                              : 'border-noir-700 hover:border-noir-600'
                          }`}
                        >
                          ...
                          <div className="flex justify-between items-center text-[10px] font-label-data text-bone-dim pt-2 border-t border-noir-700">
                            ...
                            <span className="text-gold">{art.slotsRemaining} slots left</span>
                          </div>
                        </div>
                      );
                    })}
                  ...
                  <div className="p-6 bg-noir-850 border border-noir-700 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block font-label-caps text-xs text-bone-dim uppercase mb-2">
                        Preferred Date
                      </label>
                      <input
                        type="date"
                        ...
                        className="w-full px-3 py-2.5 bg-noir-900 border border-noir-700 text-bone font-label-data text-xs focus:outline-none focus:border-crimson"
                      />
                    </div>
                ...
                <section className="space-y-6">
                  ...
                  <div className="p-6 bg-noir-850 border border-noir-700 space-y-4">
                    ...
                    <div className="pt-2">
                      <label className="flex items-start gap-3 cursor-pointer text-xs font-body-sm text-bone-muted">
                        <input
                          type="checkbox"
                          checked={medicalCheck}
                          onChange={(e) => setMedicalCheck(e.target.checked)}
                          className="mt-0.5 rounded border-noir-700 text-crimson-light focus:ring-0"
                        />
                        <span>
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-crimson hover:bg-crimson-hover text-bone font-label-caps text-xs uppercase tracking-[0.25em] transition-all btn-gothic-glow flex items-center justify-center gap-2 border border-crimson/40 disabled:opacity-50 disabled:cursor-not-allowed font-bold mt-4"
                    >
              ...
              <div className="lg:col-span-4 space-y-6">
                <div className="sticky top-28 bg-noir-850 p-6 border border-noir-700 shadow-2xl space-y-6">
                  <div className="flex items-center justify-between pb-3 border-b border-noir-700">
                    ...
                    <span className="font-label-caps text-[9px] text-gold uppercase tracking-wider">
                      Ref #9921
                    </span>
                  </div>
                  ...
                  <div className="space-y-3 font-label-data text-xs">
                    <div className="flex justify-between py-1 border-b border-noir-700/40">
                      <span className="text-bone-dim uppercase">Discipline:</span>
                      <span className="text-bone font-semibold">{selectedDiscipline}</span>
                    </div>

                    <div className="flex justify-between py-1 border-b border-noir-700/40">
                      <span className="text-bone-dim uppercase">Zone:</span>
                      <span className="text-bone font-semibold">{selectedZone}</span>
                    </div>

                    <div className="flex justify-between py-1 border-b border-noir-700/40">
                      <span className="text-bone-dim uppercase">Scale:</span>
                      <span className="text-bone font-semibold">{selectedDimension}</span>
                    </div>

                    <div className="flex justify-between py-1 border-b border-noir-700/40">
                      <span className="text-bone-dim uppercase">Artist:</span>
                      <span className="text-crimson-light font-bold">{selectedArtist}</span>
                    </div>

                    <div className="flex justify-between py-1 border-b border-noir-700/40">
                      <span className="text-bone-dim uppercase">Scheduled:</span>
                      <span className="text-gold font-bold">{selectedDate}</span>
                    </div>

                    <div className="flex justify-between py-1 border-b border-noir-700/40">
                      <span className="text-bone-dim uppercase">Window:</span>
                      <span className="text-bone">{selectedTimeSlot.split(' ')[0]}</span>
                    </div>
                  </div>

                  {/* Calculated Deposit */}
                  <div className="p-4 bg-noir-950 border border-noir-700 space-y-2">
                    <div className="flex justify-between items-center font-label-caps text-xs">
                      <span className="text-bone-dim uppercase">Consultation Deposit:</span>
                  ...
                  <div className="p-3 bg-noir-900 border border-gold/30 space-y-2">
                    ...
                    <button
                      onClick={onOpenWhatsApp}
                      className="w-full py-2 bg-noir-800 hover:bg-noir-700 text-bone font-label-caps text-xs uppercase tracking-wider transition-colors border border-noir-700 text-center block"
                    >
                      Message on WhatsApp
                    </button>
                  </div>
            ...
            >
              <div className="w-20 h-20 rounded-full bg-crimson/30 border border-crimson text-crimson-light flex items-center justify-center mx-auto shadow-2xl">
              ...
              <div className="space-y-3">
                ...
                <p className="font-body-md text-sm text-bone-muted max-w-lg mx-auto leading-relaxed">
                  Thanks, <span className="text-bone font-bold">{patronName || 'friend'}</span>. We'll review your details and confirm your appointment ({selectedDate}) within 4 business hours.
                </p>
              </div>

              <div className="p-6 bg-noir-850 border border-noir-700 text-left font-label-data text-xs space-y-2 max-w-md mx-auto">
                <div className="flex justify-between text-bone-dim">
                  <span>Discipline:</span>
                  <span className="text-bone">{selectedDiscipline}</span>
                </div>
                <div className="flex justify-between text-bone-dim">
                  <span>Artist:</span>
                  <span className="text-crimson-light font-bold">{selectedArtist}</span>
                ...
                <div className="flex justify-between text-bone-dim">
                  <span>Placement:</span>
                  <span className="text-bone">{selectedZone}</span>
                </div>
                <div className="flex justify-between text-bone-dim">
                  <span>Date:</span>
                  <span className="text-gold font-bold">{selectedDate}</span>
                ...
                <div className="flex justify-between text-bone-dim">
                  <span>Phone:</span>
                  <span className="text-bone">{patronPhone || 'Verified'}</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-noir-800 hover:bg-noir-700 text-bone font-label-caps text-xs uppercase tracking-wider transition-colors border border-noir-700"
                >
                  Back to Home
                </button>
              </div>
