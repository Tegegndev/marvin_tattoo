...
export const PORTFOLIO_DATA: PortfolioPiece[] = [
  {
    ...
    description: 'Photo-realistic black-and-grey tribute portrait on the forearm with hyper-detailed headwrap texturing and smooth skin tones.',
  ...
  },
  {
    ...
    flashId: '#701-MP',
    image: '/images/portfolio/portrait-elder-woman.png',
    description: 'High-detail black-and-grey realism tribute portrait executed with smooth gradient shading and fine headwrap texturing.',
    duration: '6 Hours Single Session',
    pigment: 'Dynamic Carbon Deep',
