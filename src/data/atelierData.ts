...
export const SERVICES_DATA: ServiceItem[] = [
  {
    ...
    description: 'Specializing in lifelike portraits, memorial pieces, wildlife, and classical sculptures in black-and-grey. Each piece is designed to flow naturally with your anatomy and retain deep contrast as it heals.',
    longDescription: 'Specializing in lifelike portraits, memorial pieces, wildlife, and classical sculptures in black-and-grey. Each piece is designed to flow naturally with your anatomy and retain deep contrast as it heals.',
    category: 'TATTOO',
  ...
  },
  {
    ...
    description: 'Clean single-needle fine lines, delicate botanical florals, subtle geometric accents, and micro-tattoos crafted with steady hand control.',
    longDescription: 'Clean single-needle fine lines, delicate botanical florals, subtle geometric accents, and micro-tattoos crafted with steady hand control.',
    category: 'TATTOO',
  ...
  },
  {
    ...
    description: 'Freehand custom lettering, Chicano cursive, sharp Gothic Old English, names, and meaningful quotes shaped to the contours of your body.',
    longDescription: 'Freehand custom lettering, Chicano cursive, sharp Gothic Old English, names, and meaningful quotes shaped to the contours of your body.',
    category: 'TATTOO',
  ...
  },
  {
    ...
    description: 'Solid saturated blackwork, African & Polynesian heritage patterns, geometric armor, and bold classic flash art.',
    longDescription: 'Solid saturated blackwork, African & Polynesian heritage patterns, geometric armor, and bold classic flash art.',
    category: 'TATTOO',
  ...
  },
  {
    ...
    description: 'Smart cover designs and rework restorations for faded, unwanted, or poorly executed old tattoos and scar camouflage.',
    longDescription: 'Smart cover designs and rework restorations for faded, unwanted, or poorly executed old tattoos and scar camouflage.',
    category: 'TATTOO',
  ...
  },
  {
    ...
    description: 'Aesthetic cosmetic enhancement including microblading, ombré powder brows, lip blush tinting, and stretch mark / scar camouflage.',
    longDescription: 'Aesthetic cosmetic enhancement including microblading, ombré powder brows, lip blush tinting, and stretch mark / scar camouflage.',
    category: 'PMU',
  ...
  },
  {
    ...
    description: 'Sterile ear, facial, oral, navel, surface microdermals, and body piercings with implant-grade ASTM F-136 titanium jewelry.',
    longDescription: 'Sterile ear, facial, oral, navel, surface microdermals, and body piercings with implant-grade ASTM F-136 titanium jewelry.',
    category: 'PIERCING',
  ...
  },
  {
    ...
    description: 'Targeted laser tattoo fading for cover-ups or removal, alongside certified treatment protocols for ear and body keloids.',
    longDescription: 'Targeted laser tattoo fading for cover-ups or removal, alongside certified treatment protocols for ear and body keloids.',
    category: 'REMOVAL',
...
export const PORTFOLIO_DATA: PortfolioPiece[] = [
  ...
  },
  {
    ...
    flashId: '#109-FL',
    image: 'https://images.unsplash.com/photo-1611501275019-9b5cda994e8d?auto=format&fit=crop&w=1000&q=80',
    description: 'Delicate single-needle 0.25mm botanical branch wrapping seamlessly around the wrist with zero blowout.',
    duration: '2 Hours Single Needle',
    pigment: 'Dynamic Bugpin Black',
    morphology: 'Radial Wrist & Forearm',
    featured: true
  },
  {
    id: 'piece-08',
    ...
    flashId: '#773-GS',
    image: 'https://images.unsplash.com/photo-1562962230-16e4623d36e6?auto=format&fit=crop&w=1000&q=80',
    description: 'Hand-drawn custom Chicano and Gothic blackletter lettering across the upper chest with smooth gradient drop shadows.',
    duration: '3.5 Hours Session',
    pigment: 'Opaque Triple Black',
    morphology: 'Upper Pectoral & Clavicle'
  },
  {
    id: 'piece-09',
    ...
    flashId: '#904-TR',
    image: 'https://images.unsplash.com/photo-1568515045052-f9a854d70bfd?auto=format&fit=crop&w=1000&q=80',
    description: 'Solid saturated jet-black geometric armor cap and Polynesian tribal motifs customized to shoulder anatomy.',
    duration: '8 Hours Full Day',
    pigment: 'Kuro Sumi Opaque Black',
    morphology: 'Deltoid & Bicep'
  },
  {
    id: 'piece-10',
    ...
    flashId: '#612-CU',
    image: 'https://images.unsplash.com/photo-1590246814883-57833748b615?auto=format&fit=crop&w=1000&q=80',
    description: 'Complete 100% concealment of an old faded 10-year tribal tattoo using strategic contrast, layered greywash, and organic petals.',
    duration: '6 Hours Layered Session',
    pigment: 'Dynamic Heavy Black & Silverback',
    morphology: 'Outer Deltoid'
  },
  {
    id: 'piece-11',
    ...
    flashId: '#314-PC',
    image: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=1000&q=80',
    description: 'Aseptic needle piercing with mirror-polished ASTM F-136 implant-grade titanium studs and bezel-set crystal gems.',
    duration: '30 Mins Procedure',
    pigment: 'ASTM F-136 Titanium',
    morphology: 'Auricular Cartilage'
  },
  {
    id: 'piece-12',
    ...
    flashId: '#105-LS',
    image: 'https://images.unsplash.com/photo-1512290900672-1f02e1a3ef78?auto=format&fit=crop&w=1000&q=80',
    description: 'Q-switched Nd:YAG laser ink shattering sessions creating a pristine, clean canvas ready for a fresh realism tattoo.',
    duration: '20 Mins per Session',
    pigment: 'Nd:YAG 1064nm Dual Pulse',
    morphology: 'Dermal Clearance'
  }
];
